...
import { FONT_POSITION_ACTION } from '../../../../store/actions/status.action';
...
const mapDispatchToProps = (dispatch) => {
    return {
        onPositionSelected: (payload) => { dispatch(FONT_POSITION_ACTION(payload)) },
    }
}
...
class StampPosition extends React.Component {
    ...
    componentDidMount() {
        ...
        this.props.navigation.setOptions({ title: 'Font Position' })
        try {
    ...
    renderLogoByposition = () => {
        ...
        const { markedTextHistory } = this.props;
            ...
            case 0:
                return (
                    <View style={[styles.logoContainer, {
                        ...
                        <Text style={styles.overlayText}>{markedTextHistory}</Text>
                    </View>
                )
            case 1:
                return (
